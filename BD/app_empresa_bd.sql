...
CREATE DATABASE IF NOT EXISTS `app_empresa_bd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `app_empresa_bd`;

-- Volcando estructura para tabla tbl_empleados
...
-- Insertando datos para la tabla tbl_empleados
...
(4, 'Lisao', 'Vega', 1, '54544454', 'dev@gmail.com', 'Ingeniero de Sistemas', 'fda30f83ebbc4fb1a2ce2609b2b1e34c6614c1dff6e44460b9ba27ed5bb8e927.png', 3500000, '2023-08-23 17:04:49'),
...
-- Insertando datos para la tabla users
